	...
	$(function () {
	    ...
	    Home.prototype = {
	        ...
	        render: function render() {
	            this.loadingImg();
	            Promise.all([this.loadingBanner(), this.loadingComent()]).then(function () {
	                $("#loading").hide();
	            });
	        },
	        ...
	        loadingBanner: function loadingBanner() {
	            //轮播图部分
	            return new Promise(function (resolve, reject) {
	                dingeTools.banner({}, -1).then(function (result) {
	                    var html = "";
	        ...
	        loadingComent: function loadingComent() {
	            var _this = this;

	            return new Promise(function (resolve, reject) {
	                _this.nextPage().then(function (res) {
	                    ...
	                    data.length > 0 && data.forEach(function (item, index) {
	                        ...
	                        html += "'>" + "<img class='home_comment_img flex-normal' src='" + item.movie.images.small + "' alt=''>" + "<div class='home_comment flex-normal'>" + "<div class='home_comment_author font-normal'>" + "<em>" + dingeTools.fromNow(item.createdAt) + "</em>" + "<a href='other_means.html'><span style='background-image:url(../.." + item.commentFrom.avatar + ");'>" + item.commentFrom.nickname + "</span></a>" + "</div>" + "<div class='home_comment_title'>" + item.content + "</div>" + "<div class='flex-container home_comment_meta font-normal'>" + "<div class='flex-normal'>阅读<span>" + item.reading + "</span></div>" + "<div class='flex-normal'>评论<span>" + item.rank + "</span></div>" + "<div class='flex-normal'>喜欢<span>" + item.weight + "</span></div>" + "</div>" + "</div>" + "</div>";
	                    });
