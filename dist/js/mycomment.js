	...
	(function ($) {
	    ...
	    MyComment.prototype = {
	        ...
	        getTemplate: function getTemplate(item) {
	            return "<div class='info_mini'>" + "<div class='info_slide'>" + "<a href='javascript:;'>" + "<div class='mycomment_title font-h'>「" + item.content + "」</div>" + "<ul class='mycomment_body font-normal'><li class='mycomment_heart'><img src='../images/comment_likeS.png' alt=''><span>" + item.star + "</span></li><li class='mycomment_say'><img src='../images/comment_commentS.png' alt=''><span>" + item.reading + "</span></li></ul>" + "</a>" + "</div>" + "<div class='del_info_btn' data-id='" + item._id + "'></div>" + "<div class='del_info_mask'></div>" + "</div>";
	        },
	        deleteSlider: function deleteSlider() {
	            var _this = this;
	            ...
	            this.ele.on("touchend", ".del_info_btn", function (event) {
	                ...
	                _this.deleteAction({
	                    ...
	                    if (result.status == 1 && result.data) {
	                        ...
	                        var template = _this.getTemplate(item);
	                        _this.mySwiper.params.onlyExternal = true;
	                        _this.mySwiper.appendSlide(template);
	                        _this.mySwiper.params.onlyExternal = false;
	                        //Update active slide
	                        _this.mySwiper.updateActiveSlide(0);
	                    }
	                });
	        ...
	        showList: function showList() {
	            ...
	            this.page++;
	            // 加载数据
	            this.loadCommentList(this.page).then(function (result) {
	                // 拼凑数据
	        ...
	        loadCommentList: function loadCommentList(page) {
	        ...
	        initSwiper: function initSwiper(result) {
	            var getTemplate = this.getTemplate,
	                loadCommentList = this.loadCommentList;
	            ...
	            this.mySwiper = new Swiper(".swiper-container", {
	                ...
	                onTouchEnd: function onTouchEnd() {
	                    ...
	                    // 加载新的slide
	                    loadCommentList(self.page).then(function (result) {
	                        if (result.status == 1 && result.data.list.length > 0) {
	                            var data = result.data.list;
	                            data.forEach(function (item) {
