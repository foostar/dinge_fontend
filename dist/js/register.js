	    ...
	    register.prototype = {
	        ...
	        bindEvent: function bindEvent() {
	            ...
	            $(".login_btn").on("click", function () {
	                _this.errMsg.splice(0, _this.errMsg.length);
	                var type = $(_this).attr("data-type");
	                _this.formatData(type);
	                if (_this.errMsg.length > 0) {
	                    return console.log(_this.errMsg[0], _this.errMsg);
	                }
	                _this.submitData(type).done(function (result) {
	                    if (result.status == 1) {
	                        console.log(type + "成功！");
	        ...
	        formatData: function formatData(type) {
	            if (type == "login") {
	                return this.formatLogin();
	            }
	            this.formatRegister();
	        },
	        formatLogin: function formatLogin() {
	        ...
	        formatRegister: function formatRegister() {
	        ...
	        submitData: function submitData(type) {
	            if (type == "login") {
