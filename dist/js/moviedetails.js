...
/***/ function(module, exports, __webpack_require__) {
	...
	(function ($) {
	    ...
	    MyCollet.prototype = {
	        ...
	        getTemplate: function getTemplate(item) {
	            //debugger
	            return "<a href='moviedetails_comment.html?id=" + item._id + "'>" + "<div class='info_mini'>" + "<div class='info_slide'>" + "<div class='mycollet_author font-normal'>" + "<div class='m_detail_left'>" + "<img src='" + item.commentFrom.avatar + "' alt=''><span>" + item.commentFrom.nickname + "</span>" + "</div>" + "<div class='m_detail_comment'>" + item.rank + "</div>" + "</div>" + "<div class='mycollet_title m_detail_title'>" + item.title + "</div>" + "<div class='mycollet_content font-normal'>" + item.content + "</div>" + "</div>" + "<div class='del_info_btn' data-id='" + item._id + "'></div>" + "</div>" + "</a>";
	        },
	        deleteSilder: function deleteSilder() {
	            var _this = this;

	            var deleteAction = this.deleteAction,
	                page = this.page,
	                mySwiper = this.mySwiper,
	                getTemplate = this.getTemplate;
	            // 删除slider

	            this.ele.on("touchend", ".del_info_btn", function (event) {
	        ...
	        showList: function showList() {
	            ...
	            .then(function (result) {
	                _this2.makeData(result);
	                _this2.initSwiper(result);
	            });
	        },
	        loadColletList: function loadColletList(page) {
	        ...
	        moviedetailsTop: function moviedetailsTop() {
	            //TODO 加载头部部分
	            //debugger
	            var id = dingeTools.getURLParam("id");
	            return $.ajax({
	                ...
	                success: function success(result) {
	                    ...
	                    if (result.status == 1 && result.data.length > 0) {
	                        ...
	                        data.forEach(function (item) {
	                            html += "<a href='moviedetails_top.html?id=" + item._id + "'>" + "<div class='m_details_topimg'><img src=" + item.images.large + " alt=''></div>" + "<div class='m_d_top_position'>" + "<div class='m_mask font-normal'><span class='font-title'>" + item.rating.average + "</span>评分</div>" + "<p class='font-bold'>" + "<span>" + item.title + "</span>" + "<span>" + item.aka[0].name + "</span>" + "<span>" + item.etitle + "</span>" + "</p>" + "</div>" + "</a>";
	                        });
	        ...
	        initSwiper: function initSwiper(result) {
	            var mySwiper = this.mySwiper,
	                holdPosition = this.holdPosition,
	                page = this.page,
	                loadColletList = this.loadColletList,
	                getTemplate = this.getTemplate;
	            ...
	            if (result.status == 1 && page == 0) {
	                ...
	                mySwiper = new Swiper(".swiper-container", {
	                    ...
	                    onResistanceAfter: function onResistanceAfter(s, pos) {
	                        holdPosition = pos;
	                    },
	                    onTouchEnd: function onTouchEnd() {
	                        if (holdPosition > 100) {
	                            ...
	                            //加载新的slide
	                            loadColletList(page).then(function (result) {
	                                if (result.status == 1 && result.data.list.length > 0) {
	                                    var data = result.data.list;
	                                    data.forEach(function (item) {
	                                        var template = getTemplate(item);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(Zepto, $, __webpack_provided_window_dot_Zepto) {"use strict";
	...
	*/
	var Swiper = function Swiper(a, b) {
	  "use strict";
	  function c(a, b) {
	    return document.querySelectorAll ? (b || document).querySelectorAll(a) : Zepto(a, b);
	  }function d(a) {
	  ...
	  }), (document.querySelectorAll || __webpack_provided_window_dot_Zepto) && "undefined" != typeof a && (a.nodeType || 0 !== c(a).length)) {
	    var D = this;D.touches = { start: 0, startX: 0, startY: 0, current: 0, currentX: 0, currentY: 0, diff: 0, abs: 0 }, D.positions = { start: 0, abs: 0, diff: 0, current: 0 }, D.times = { start: 0, end: 0 }, D.id = new Date().getTime(), D.container = a.nodeType ? a : c(a)[0], D.isTouched = !1, D.isMoved = !1, D.activeIndex = 0, D.centerIndex = 0, D.activeLoaderIndex = 0, D.activeLoopIndex = 0, D.previousIndex = null, D.velocity = 0, D.snapGrid = [], D.slidesGrid = [], D.imagesToLoad = [], D.imagesLoaded = 0, D.wrapperLeft = 0, D.wrapperRight = 0, D.wrapperTop = 0, D.wrapperBottom = 0, D.isAndroid = navigator.userAgent.toLowerCase().indexOf("android") >= 0;var E,
	      ...
	      }D.callPlugins("onDestroy"), __webpack_provided_window_dot_Zepto && __webpack_provided_window_dot_Zepto(D.container).data("swiper") && __webpack_provided_window_dot_Zepto(D.container).removeData("swiper"), __webpack_provided_window_dot_Zepto && __webpack_provided_window_dot_Zepto(D.container).data("swiper") && __webpack_provided_window_dot_Zepto(D.container).removeData("swiper"), D = null;
	    ...
	    }(), ie10: window.navigator.msPointerEnabled, ie11: window.navigator.pointerEnabled } }, (__webpack_provided_window_dot_Zepto || __webpack_provided_window_dot_Zepto) && !function (a) {
	  "use strict";
	...
	}(__webpack_provided_window_dot_Zepto || __webpack_provided_window_dot_Zepto),  true ? module.exports = Swiper : "function" == typeof define && define.amd && define([], function () {
	  "use strict";
	  return Swiper;
	});
