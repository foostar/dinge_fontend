	...
	(function ($) {
	    ...
	    MyFocus.prototype = {
	        ...
	        getTemplate: function getTemplate(item) {
	            return "<div class='info_normal'>" + "<div class='info_slide'>" + "<div class='myfocus_carouse'>" + "<a href='javascript:;'>" + "<img src='" + item.avatar + "'>" + "</a>" + "</div>" + "<div class='myfocus_content'>" + "<a href='javascript:;'>" + "<div class='myfocus_nickname'>" + item.nickname + "</div>" + "<div class='myfocus_notice font-normal'>" + item.sign + "</div>" + "</a>" + "</div>" + "</div>" + "<div class='del_info_btn' data-id='" + item._id + "'></div>" + "<div class='del_info_mask'></div>" + "</div>";
	        },
	        ...
	        loadFocusList: function loadFocusList(page) {
	            return $.ajax({
	        ...
	        showList: function showList() {
	            // 加载数据
	            this.loadFocusList(this.page).then(function (result) {
	                // 拼凑数据
	        ...
	        initSwiper: function initSwiper(result) {
	            var getTemplate = this.getTemplate,
	                loadFocusList = this.loadFocusList;
	            ...
	            this.mySwiper = new Swiper(".swiper-container", {
	                ...
	                onTouchEnd: function onTouchEnd() {
	                    ...
	                    // 加载新的slide
	                    loadFocusList(self.page).then(function (result) {
