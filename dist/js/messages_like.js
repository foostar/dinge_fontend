	...
	$(function () {
	    ...
	    MessagesLike.prototype = {
	        ...
	        showList: function showList() {
	            ...
	            // 加载数据
	            this.loadCommentList().then(function (result) {
	                // 拼凑数据
	        ...
	        makeData: function makeData(result) {
	            ...
	            if (result.status == 1 && result.data.list.length > 0) {
	                ...
	                data.forEach(function (item) {
	                    html += "<div class='swiper-wrapper'>" + "<div class='swiper-slide'>" + "<div class='like'><em>" + item.commentFrom.nickname + "</em>" + "喜欢了你的「<span>" + item.content + "</span>」</div>" + "</div>" + "</div>";
	                });
