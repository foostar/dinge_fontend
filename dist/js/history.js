	...
	$(function () {
	    ...
	    History.prototype = {
	        ...
	        showList: function showList() {
	            ...
	            // 加载数据
	            this.loadHistoryList().then(function (result) {
	                // 拼凑数据
	                _this.makeData(result);
	                // 初始化swiper
	                _this.initSwiper(result);
	            });
	        },
	        ...
	        makeData: function makeData(result) {
	            ...
	            if (result.status == 1 && result.data.list.length > 0) {
	                ...
	                data.forEach(function (item) {
	                    html += "<div class='swiper-wrapper'>" + "<div class='swiper-slide'>" + "<div class='info_large'>" + "<a href='javascript:;'>" + "<div class='history_title'>「" + item.title + "」</div>" + "<div class='history_date font-normal'>" + dingeTools.fromNow(item.createdAt) + "</div>" + "</a>" + "</div>" + "</div>" + "</div>";
	                });
