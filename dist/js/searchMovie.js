	...
	$(function () {
	    ...
	    */
	    ...
	    SearchMovie.prototype = {
	        ...
	        movieModule: function movieModule() {
	            //电影模块
	            $.ajax({
	                ...
	                if (res.status == 1) {
	                    ...
	                    for (var i = 0; i < data.length; i++) {
	                        ...
	                        html += "<ul>" + "<li class='search_tag1img'><img src=" + data[i].images.large + " alt=''></li>" + "<li class='search_tag1txt'>" + "<div class='tag1_title font-title'>" + data[i].title + "</div>" + "<div class='tag1_midtxt'><span class='font-normal'>" + monsubstr + "</span><em class='font-normal'>" + data[i].directors[i].name + "</em></div>" + "<div class='tag1_bnttxt font-normal'><span class='font-title'>" + data[i].rating.average + "</span>评分</div>" + "</li>" + "</ul>";
	                    }
	                    $(html).appendTo($("#searchMovie_movie"));
	                }
	            });
	        },
	        reviewModule: function reviewModule() {
	            //影评模块
	            $.ajax({
	                ...
	                if (res.status == 1) {
	                    ...
	                    //console.log(data);         
	                    for (var i = 0; i < data.length; i++) {
	                        html += "<div class='review_div'>" + "<div class='review_title font-title'>" + data[i].title + "</div>" + "<span class='font-normal'>——《" + data[i].movie + "》</span>" + "<p class='font-normal'>" + data[i].content + "</p>" + "</div>";
	                    }
	        ...
	        userModule: function userModule() {
	            $.ajax({
	                ...
	                if (res.status == 1) {
	                    ...
	                    for (var i = 0; i < data.length; i++) {
	                        html += "<ul class='movie_user'>" + "<li class='user_img'><a href='javascript:;'><img src=" + data[i].commentFrom.avatar + " alt=''></a></li>" + "<li class='user_txt'>" + data[i].commentFrom.nickname + "</li>" + "</ul>";
	                    }
	        ...
	        tab: function tab() {
	            ...
	            $("#tag li").click(function () {
	                $("#tag li").eq($(_this).index()).addClass("current").siblings().removeClass("current");
	                $(".tagClass").hide().eq($(_this).index()).show();
	            });
	        },
