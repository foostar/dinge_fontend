	...
	(function ($) {
	    ...
	    Message.prototype = {
	        ...
	        getRefresh: function getRefresh() {
	            ...
	            $(".chat-refresh").on("touchend", function () {
	                _this.showList();
	            });
	        },
	            ...
	            $("#sendMessage").submit(function (event) {
	                ...
	                if (messageInput) {
	                    ...
	                    _this2.sendPost({
	                        ...
	                        if (result.status == 1) {
	                            mySwiper.appendSlide("<div class='swiper-slide swiper-from'>" + "<div class='dialog_carouse'><img src='" + result.data.avatar + "'/></div>" + "<div class='triangle-right'></div>" + "<div class='dialog_content'>" + messageInput + "</div>" + "</div>");
	                            var swiperHeight = $(".swiper-wrapper").height();
	                            var containerHeight = _this2.mySwiper.height;
	        ...
	        showList: function showList() {
	            ...
	            // 加载数据
	            this.loadMessage(this.page).then(function (result) {
	                // 拼凑数据
	                _this3.makeData(result);
	                // 初始化swiper
	                _this3.initSwiper(result);
	            });
	        },
	        ...
	        makeData: function makeData(result) {
	            if (result.status == 1 && result.data.list.length > 0) {
	                ...
	                data.forEach(function (item) {
	                    ...
	                    html += "<div class='swiper-slide'>" + "<div class='swiper-slide-warpper " + frome + "'>" + "<div class='dialog_carouse'><img src='" + item.from.avatar + "'/></div>" + "<div data-to='" + item.to._id + "' class='triangle-" + direction + "'></div>" + "<div class='dialog_content'>" + item.content + "</div>" + "</div>" + "</div>";
	                });
	        ...
	        initSwiper: function initSwiper(result) {
	            ...
	            if (result.status == 1 && this.page == 1) {
	                ...
	                mySwiper = new Swiper(".swiper-container", {
	                    ...
	                    onResistanceBefore: function onResistanceBefore(s, pos) {
	                        holdPosition = pos;
	                    },
	                    onTouchEnd: function onTouchEnd() {
	                        if (holdPosition > 100) {
	                            ...
	                            //加载新的slide
	                            loadMessage(page).done(function (result) {
	                                if (result.status == 1 && result.data.list.length > 0) {
	                                    var data = result.data.list;
	                                    data.forEach(function (item) {
	                                        var frome = "",
	                                        ...
	                                        mySwiper.prependSlide("<div class='swiper-slide-warpper " + frome + "'>" + "<div class='dialog_carouse'><img src='" + item.from.avatar + "'/></div>" + "<div class='triangle-" + direction + "'></div>" + "<div class='dialog_content'>" + item.content + "</div>" + "</div>");
	                                    });
