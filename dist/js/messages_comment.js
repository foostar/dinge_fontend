	...
	(function ($) {
	    ...
	    MessagesComment.prototype = {
	        ...
	        getTemplate: function getTemplate(item) {
	            return "<div class='info_large'>" + "<div class='info_slide'>" + "<div class='mescomment_carouse'>" + "<a href='javascript:;'>" + "<img src='" + item.commentFrom.avatar + "' alt=''>" + "<em class='font-normal'>" + item.commentFrom.nickname + "</em>" + "</a>" + "</div>" + "<div class='mescomment_comment'>" + "<a href='javascript:;'>" + "<p class='font-bold'>" + item.content + "</p>" + "<h4 class='font-normal'>——「<span>" + item.commentId.title + "</span>」</h4>" + "</a>" + "</div>" + "</div>" + "<div class='del_info_btn' data-id='" + item._id + "'></div>" + "<div class='del_info_mask'></div>" + "</div>";
	        },
	        ...
	        loadMessageComment: function loadMessageComment(data) {
	        ...
	        makeData: function makeData(result) {
	            ...
	            if (result.status == 1 && result.data.list.length > 0) {
	                ...
	                data.forEach(function (item) {
	                    html += "<div class='swiper-slide'>" + _this.getTemplate(item) + "</div>";
	                });
	        ...
	        initSwiper: function initSwiper(result) {
	            var mySwiper = this.mySwiper,
	                ...
	                page = this.page,
	                loadMessageComment = this.loadMessageComment,
