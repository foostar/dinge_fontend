...
dingeUi.LUploader = function(el, params) {
    var _self = this;
    _self.trigger=el;
    _self.params = {
        accept: 'image/*',
...
dingeUi.LUploader.prototype.init = function() {
    var _self = this;
...
dingeUi.LUploader.prototype.compress = function(img) {
...
dingeUi.LUploader.prototype.upload = function(url, obj, basestr, type, li) {
